...
const CATEGORIES: Record<string, CategoryMeta> = {
  pt: {
    ...
    subheadline:
      "서비스·가격·후기·카카오 상담을 한 페이지에 담아 신규 회원 전환을 높이세요.",
    painPoint:
      "인스타 바이오 링크가 단순 카카오 링크뿐이라 고객이 이탈하고 있지 않으신가요?",
    benefit:
      "PT 1회·10회·20회 패키지 가격을 한눈에 보여주고 카카오로 바로 상담 연결",
    services: [
      "PT 1회",
      "PT 10회 패키지",
      "PT 20회 패키지",
  ...
  pilates: {
    ...
    subheadline:
      "그룹·개인 레슨 일정과 가격을 정리하고 네이버·카카오 예약까지 연결하세요.",
  ...
  yoga: {
    ...
    subheadline:
      "클래스 일정, 가격, 후기를 한 페이지에 정리하고 신규 수강생을 유치하세요.",
    painPoint:
      "인스타 프로필 링크 하나로 클래스 안내부터 예약까지 해결하고 싶지 않으신가요?",
  ...
  salon: {
    ...
    subheadline:
      "시술 메뉴와 가격을 정리하고 카카오·네이버 예약으로 고객을 유입하세요.",
  ...
  nail: {
    ...
    subheadline:
      "젤 네일·아트 메뉴와 가격을 한 페이지에 정리하고 예약을 자동화하세요.",
    painPoint:
      "인스타 DM으로 들어오는 가격 문의에 매번 답하느라 시간을 낭비하고 있지 않으신가요?",
  ...
  cafe: {
    ...
    subheadline:
      "메뉴와 위치, 영업시간을 한 페이지에 담아 인스타 방문자를 실제 고객으로 전환하세요.",
    painPoint:
      "인스타 팔로워는 많은데 실제 방문으로 이어지지 않아 고민이신가요?",
  ...
  freelancer: {
    ...
    subheadline:
      "서비스 포트폴리오와 가격을 정리하고 클라이언트 문의를 한 곳에서 받으세요.",
    painPoint:
      "링크트리 기본 페이지로는 서비스 설명이 부족해 문의 전환이 낮지 않으신가요?",
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-3">
            {[
              { name: "Free", price: "무료", desc: "기본 프로필, 서비스 3개" },
              {
                name: "Basic",
                price: "29,000원/월",
                desc: "서비스 무제한, 모든 테마, 후기 무제한",
              },
              {
                name: "Pro",
                price: "49,000원/월",
                desc: "Basic + 방문자 통계, 우선 지원",
              },
            ].map((p) => (
